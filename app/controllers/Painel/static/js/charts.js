/*
var chart_ranking = document.getElementById('chartRanking');

if(chart_ranking){
    
    var myRankingChart = new Chart(chart_ranking.getContext('2d'), {
        type: 'bar',
        data: {
            labels: Object.keys(month_work),
            datasets: [{
                label: 'Horas Trabalhadas',
                data: Object.values(month_work),
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
                    'rgba(54, 162, 235, 0.2)',
                    'rgba(255, 206, 86, 0.2)',
